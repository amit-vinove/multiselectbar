(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/taggedTemplateLiteral'), require('@babel/runtime/helpers/slicedToArray'), require('react'), require('react-bootstrap-icons'), require('styled-components'), require('react-bootstrap')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/taggedTemplateLiteral', '@babel/runtime/helpers/slicedToArray', 'react', 'react-bootstrap-icons', 'styled-components', 'react-bootstrap'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["react-awesome-buttons"] = factory(global._defineProperty, global._toConsumableArray, global._taggedTemplateLiteral, global._slicedToArray, global.React, global.reactBootstrapIcons, global.styled, global.reactBootstrap));
})(this, (function (_defineProperty, _toConsumableArray, _taggedTemplateLiteral, _slicedToArray, React, reactBootstrapIcons, styled, reactBootstrap) { 'use strict';
